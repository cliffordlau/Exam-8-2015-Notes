...
*To model hazard module*: Use historical data for $pdf_0$ $\Rightarrow$ Refine with scientific knowledge
...
Divide risk into classes based on building characteristics

* Identification of a typical building in each class
* Evaluation of building performance

    * $\forall$ class, intensity of force $\Leftrightarrow$ $\mathrm{E}[Damage]$ of the typical building
    
    * $Dmg(buildings_{class}) \: \Rightarrow \: DmgRatio = \dfrac{\text{Repair cost}}{\text{Replacement cost}}$
