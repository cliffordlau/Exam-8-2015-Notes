...
$\dfrac{ {\color{blue}{\left\{\mathrm{E}[x; \min(UL + PL, UL + AP +Lim)] - \mathrm{E}[x;\min(UL+PL,UL+AP)]\right\} } }(1-\phi) + \left\{ \mathrm{E}[x; \min(PL, AP+Lim)]-\mathrm{E}[x; \min(PL,AP)] \right\}\phi} { {\color{blue}{\left\{\mathrm{E}[x;UL+PL]-\mathrm{E}[x;UL]\right\} }  }(1-\phi) + \mathrm{E}[x;PL]\phi}$
