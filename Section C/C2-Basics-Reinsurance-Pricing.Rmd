...
For ceding company to retain low risk policies and only cede high risk
...
### Profit Commission  
<span style="color:green">2007 Q23</span>
...
### Loss Corridors  
<span style="color:green">2006 Q9m 2009 Q30</span>
...
4. Apply **XS LDFs** to develop XS losses
...
<span style="color:red">Not super sure what</span>
...
* Not what you want
* Check with PP/Mid-point range of IV ??
* Also affect by deductible underlying: Sub premium $\Delta$ but no underlying XS ??
...
| Exposure rating layer | From 5. | $Exp Rating Loss Cost for lower layer \times \dfrac{P(CurrentLayer)}{P(LowerLayer)}$ |
...
**Clash covers**  
Only hit due to multiple policies involving a single occurrence; or  
Extra Contractual Obligations; or  
Ruling awarding damages in XS of policy limits; or  
ALAE included in the treaty
...
3. Severity trend for individual L&ALAE
    ...
    * Treatment of limit with trend
        ...
        * Don't cap trended losses
            ...
            * Need to $\uparrow$ premiums to reflect higher limits; However difficult to quantify
...
$\text{Exposure Factor} = \dfrac{\mathrm{E}[x;\min(PL, \frac{AP + Lim}{1+e})] - \mathrm{E}[x;\min(PL,AP)]}{\mathrm{E}[x;PL]}$
...
<span style="color:green">2000 Q71</span>
...
### Swing Plans  
<span style="color:green">1999 Q37</span>
