...
![alt text](figures/Exam 8 B1-7 - 1.png){#tblmfigure1}
...
![alt text](figures/Exam 8 B1-7 - 4.png){#tblmfigure4}
...
Recall if the plan is balance $\Rightarrow$ $\mathrm{E}[R] = \text{Guaranteed Cost Premium}$ {#basicpremiumproof}
...
![alt text](figures/Exam 8 B1-7 - 5.png){#tblllmfigure1}
...
![alt text](figures/Exam 8 B1-7 - 6.png){#tbllfigure1}
