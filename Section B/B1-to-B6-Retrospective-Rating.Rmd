...
* For Table M:
    * $\mathrm{E}[R] = \big\{b + C(\mathrm{E}[A] - I)\big\}T$
* For LLM:
    * $\mathrm{E}[R^*] = \big\{b^{LLM} + C(\mathrm{E}[A^*] - I^{LLM})+PCF\big\}T$
* For L:
    * $\mathrm{E}[R^*] = \big\{b^{L} + C(\mathrm{E}[A] - I^{L})\big\}T$
...
* So have to group losses by risk (policy)
...
### Net Insurance Charge - w/o Occ Limit  
<span style="color:red;background-color:yellow">Important Concepts</span>
