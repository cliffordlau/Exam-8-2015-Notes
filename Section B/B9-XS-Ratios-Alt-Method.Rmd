...
Mean Residual Life = $e(x) = \dfrac{\text{ \$ XS of }x}{\text{# of Accidents XS of }x}$ = XS severity function
...
7. Normalize output from 2. for each HG to have mean = 1
...
![alt text](figures/Exam 8 B8 - 9 - 4.png)
...
* Weighted average of $R_j(L)$ with weight $R(L) = \dfrac{p_j \mathrm{E}_j[X]}{ \sum_j p_j \mathrm{E}_j[X]}$
