...
* $\mathrm{Pr(\text{Observed differs by more than a certain % from the predicted})}$

$\mathrm{Pr}\Big(\dfrac{\big|\hat{X}_{risks} - X_{i, risks}\big|}{\hat{X}_{risks}} > k \% \Big) < p$

**Meyers Dorweiler**

* $\rho$ between $\frac{Actual}{Expected}$ and $\frac{Expected}{Mean}$
* See Kendall's $\tau$ P.271 of paper
