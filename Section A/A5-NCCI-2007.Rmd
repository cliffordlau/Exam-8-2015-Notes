...
* PDF = $f_i(x)$
* Trended, fully developed, and on-leve
...
**Standardize XS ratio** (NCCI did not use)
...
2. Standization eliminates the common denominator; XS ratio at different limits have $\approx$ unit $\Rightarrow$ $\dfrac{\text{Dollar XS Loss}}{\text{Dollar Total Loss}}$
...
**K-mean clustering** <span style="color:red">Important</span>
