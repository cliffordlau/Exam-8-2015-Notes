...
##Retrospective Rating: w/o Occurence Limit <span style="color:red;background-color:yellow">Important Formulas</span>
...
<span style="color:red; background-color:yellow">Revisit! This seems wrong...</span>
...
***3. Calculate Entry Ratio $r$***
    * $\dfrac{Loss_Actual}{Loss_Expected}
...
$\phi(r_i) = \phi(r_{i+1}) + (r_{i+1} - r_i)(\text{Perc risks above }r_i)$ <span style="color:red; background-color:yellow"> Memorize Formula </span>
...
* For Tbl M Charge: $\text{Perc of Policies hitting cap} \times \text{XS Loss Amount}$
* For Tbl M Savings: $\text{Perc of Policies hitting cap} \times \text{Difference of the Minimum Bound and Loss Amount}
...
## Understanding Table M <span style="color:red;background-color:yellow">Important Concepts</span>

![alt text](figures/Exam 8 - 1.png)
...
![alt text](figures/Exam 8 - 3.png)

## Net Insurance Charge - w/o Occurence Limit <span style="color:red;background-color:yellow">Important Concepts</span>
...
$\begin{array}{lll}
  ...
  \mathrm{E}[R] &= (b + C(\mathrm{E}[A] - I))T & (1)\\
\end{array}$
...
* Recall:  <span style="color:red">Check</span>
$e = \dfrac{1-D}{T} - PLR$  
...
$\begin{array}{ll}
  ...
  (e + \mathrm{E}[A])T - {\color{blue}H} &= (b + C(\mathrm{E}[A] - I))T - {\color{blue}{(b + Cr_H\mathrm{E}[A])T}}\\
  &= CT\{\mathrm{E}[A] - I - r_H\mathrm{E}[A]\}\\
  &= CT\{\mathrm{E}[A] - \mathrm{E}[A](\phi(r_G) - \psi(r_H)) - r_H \mathrm{E}[A]\}\\
  &= C\mathrm{E}[A]T(\psi(r_H) - r_H + 1 - \phi(r_G))\\
\end{array}$
...
* $\phi^L(r_i) = \phi^L(r_{i+1}) + (r_{i+1} - r_i)(\text{Perc Premium above }r_i)$

<span style="color:green">2008 Q32</span>

## Understanding Table L

![alt text](figures/Exam 8 - 6.png)
